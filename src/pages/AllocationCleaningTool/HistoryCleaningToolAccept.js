      ...
      <table className="table align-middle mt-2">
        ...
        <tbody>
          <tr className="">
            ...
            <td className=" align-middle">Không có</td>
            <td className=" align-middle ">
              <span className="text-danger border border-danger rounded p-2">
          ...
          <tr className="">
            ...
            <td className="align-middle">Dùng hết</td>
            <td className=" align-middle">Ngày/Giờ yêu cầu</td>
            <td className=" align-middle">Ngày/Giờ cấp phát</td>
            <td className=" align-middle ">
              <span className="text-success border border-success rounded p-2">
