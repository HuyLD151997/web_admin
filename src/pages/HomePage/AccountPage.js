...
import * as getEmployeeSearchActions from "../../actions/Employees/SearchEmployee";
...
const AccountPage = (props) => {
  ...
  useEffect(() => {
    dispatchAction(getEmployeesActions.getEmployees(page, perPage));
  ...
  const handleSearch = () => {
    if (search === "") {
      dispatchAction(
        getEmployeeSearchActions.searchEmployee(" ", page, perPage)
      );
    }
    dispatchAction(
      getEmployeeSearchActions.searchEmployee(search, page, perPage)
    );
  };
                    ...
                    <tr className="align-middle" key={index}>
                      <td className="col-1 align-middle">
                        ...
                        <i
                          class="fa fa-edit"
                          type="button"
                          onClick={() => handleGetAndUpdateImg(item.hasAvatar)}
                          data-toggle="modal"
                          data-target="#exampleModal2"
                          data-whatever="yah"
                          style={{
